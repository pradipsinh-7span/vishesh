...
<Callout type="info">
  ...
  <em>Therefore, Vishesh Preset uses the vertical padding hack for</em>
...
As mentioned above, we are using CSS hack for aspect ratio. So, to make it proper considering the other scenarios, we have come to the conclusion that it needs 3 divs to work perfectly, and each div has its own role and responsibility.
